function run(msg)
	...
	chat = {{"Send Chat Request"},{{text="Share Your Phone Number",request_contact=true},{text="Share Your Location",request_location=true}},{"Bot Version "..bot_version},{"My Information"}}
	help = {{"Help"}}
------------------------------------------------------
	...
	elseif msg.text:find("/spam") and msg.chat.id == admingp then
		...
		if target then
			...
			elseif #target == 2 then
				send_msg(admingp, "`شخص مورد نظر در حال اسپم خوردن است`", true)
				for i=1,tonumber(target[2]) do
					send_msg(tonumber(target[1]), "Cyber Bot\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nCyber Bot")
				end
				return send_msg(admingp, "`اسپم به اتمام رسید`", true)
			else
				send_msg(admingp, "`شخص مورد نظر در حال اسپم خوردن است`", true)
